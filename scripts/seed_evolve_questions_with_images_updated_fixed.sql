...
FROM (
  VALUES
    ...
    -- Q8
    ('rules_of_road', 1, 'Unless otherwise shown by a sign, the general speed limit in an urban area is ...km/h.', '[{"text": "60"}, {"text": "80"}, {"text": "100"}]'::jsonb, 0, 'The default speed limit in urban areas is 60 km/h unless otherwise indicated by road signs.', 1, 'assets/individual_signs/SELECTIVE RESTRICTION SIGNS/Maximum of 15 vehicles.png'),
    
    -- Q9
    ('rules_of_road', 1, 'The legal speed limit which you may drive...', '[{"text": "Is always 120km/h outside an urban area"}, {"text": "Can be determined by yourself if you look at the number of lanes the road has"}, {"text": "Is shown to you by signs next to the road"}]'::jsonb, 2, 'Legal speed limits are indicated by road signs. Do not assume limits based on road type or number of lanes.', 1, 'assets/individual_signs/SELECTIVE RESTRICTION SIGNS/Maximum of 15 vehicles.png'),
    ...
    -- Q13
    ('rules_of_road', 1, 'What is the longest period that a vehicle may be parked on one place on a road outside urban areas?', '[{"text": "7 days"}, {"text": "48 hours"}, {"text": "24 hours"}]'::jsonb, 0, 'Outside urban areas, a vehicle may be parked in one place for up to 7 days unless otherwise prohibited.', 1, 'assets/individual_signs/COMPREHENSIVE SIGNS/Residential area.png'),
    
    -- Q14
    ('rules_of_road', 1, 'At an intersection...', '[{"text": "You can pass another vehicle waiting to turn right on his left side by going off the road"}, {"text": "You can stop in it to off load passengers"}, {"text": "Pedestrians who are already crossing the road when the red man signal starts showing, have right of way"}]'::jsonb, 2, 'Pedestrians already crossing when the signal changes to red have right of way to complete their crossing safely.', 2, 'assets/individual_signs/CONTROL SIGNS/Indicates that you must yield to other traffic. Gi.png'),
    
    -- Q15
    ('rules_of_road', 1, 'You are not allowed to stop...', '[{"text": "On the pavement"}, {"text": "With the front of your vehicle facing oncoming traffic"}, {"text": "Next to any obstruction in the road"}]'::jsonb, 0, 'Stopping on the pavement (sidewalk) is prohibited as it obstructs pedestrian access.', 1, 'assets/individual_signs/CONTROL SIGNS/Stop in line with the Stop sign or before the line.png'),
    
    -- Q16
    ('rules_of_road', 1, 'You are not allowed to stop...', '[{"text": "Where you are also prohibited to park"}, {"text": "5m from a bridge"}, {"text": "Opposite a vehicle, where the roadway is 10m wide"}]'::jsonb, 0, 'If an area is designated as no parking, it also means no stopping. Other restrictions may have specific distances.', 2, 'assets/individual_signs/CONTROL SIGNS/Stop in line with the Stop sign or before the line.png'),

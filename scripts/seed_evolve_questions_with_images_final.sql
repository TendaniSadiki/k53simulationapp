...
FROM (
  VALUES
    ...
    -- Q8 - Speed limit sign
    ('rules_of_road', 1, 'Unless otherwise shown by a sign, the general speed limit in an urban area is ...km/h.', '[{"text": "60"}, {"text": "80"}, {"text": "100"}]'::jsonb, 0, 'The default speed limit in urban areas is 60 km/h unless otherwise indicated by road signs.', 1, 'assets/individual_signs/LIMIT PROHIBITION SIGNS/Maximum speed limit allowed.png'),
    
    -- Q9 - Speed limit sign
    ('rules_of_road', 1, 'The legal speed limit which you may drive...', '[{"text": "Is always 120km/h outside an urban area"}, {"text": "Can be determined by yourself if you look at the number of lanes the road has"}, {"text": "Is shown to you by signs next to the road"}]'::jsonb, 2, 'Legal speed limits are indicated by road signs. Do not assume limits based on road type or number of lanes.', 1, 'assets/individual_signs/LIMIT PROHIBITION SIGNS/Maximum speed limit allowed.png'),
    ...
    -- Q18 - No overtaking for goods vehicles
    ...
    -- Q32
    ('rules_of_road', 1, 'When you were involved in an accident you...', '[{"text": "Must immediately stop your vehicle"}, {"text": "Must see if someone is injured"}, {"text": "May use a bit of alcohol for the shock"}, {"text": "Only (i) and (ii) are correct"}]'::jsonb, 3, 'Stop immediately, check for injuries, and render assistance. Never consume alcohol after an accident.', 2, NULL),


    ('rules_of_road', 1, 'When you were involved in an accident you...', '[{"text": "Must immediately stop your vehicle"}, {"text": "Must see if someone is injured"}, {"text": "May use a bit of alcohol for the shock"}, {"text": "Only (i) and (ii) are correct"}]'::jsonb, 3, 'Stop immediately, check for injuries, and render assistance. Never consume alcohol after an accident.', 2, NULL),
    
    -- Q33
    ('rules_of_road', 1, 'When do you have the right of way?', '[{"text": "When you are within a traffic circle"}, {"text": "When you have stopped first at a four – way stop"}, {"text": "When you want to turn right at an intersection in a two-way road"}, {"text": "Only (i) and (ii) are correct"}]'::jsonb, 3, 'You have right of way when already in a traffic circle and when you stop first at a four-way stop intersection.', 2, NULL),
    
    -- Q34
    ('rules_of_road', 1, 'If you come across an emergency vehicle on the road sounding a siren you must...', '[{"text": "Flash your headlight to warn other traffic"}, {"text": "Give right of way to the emergency vehicle"}, {"text": "Switch on your vehicles emergency light and blow your hooter"}]'::jsonb, 1, 'Yield right of way to emergency vehicles by moving to the side of the road and allowing them to pass safely.', 1, NULL),
    
    -- Q35
    ('rules_of_road', 1, 'If you want to turn left with your vehicle, you must...', '[{"text": "Slow down completely, stop and then turn"}, {"text": "First move to the right to enable you to turn left easily"}, {"text": "Give the necessary signal in good time"}]'::jsonb, 2, 'Always signal your intention to turn left in good time to alert other road users of your planned maneuver.', 1, NULL),
    
    -- Q36
    ('rules_of_road', 1, 'When you drive...', '[{"text": "You must have both hands on the steering wheel"}, {"text": "Your vision of the road and the traffic must be unobstructed"}, {"text": "You must wear shoes with rubber soles"}]'::jsonb, 1, 'Your view of the road and traffic must always be clear and unobstructed for safe driving.', 1, NULL),
    
    -- Q37
    ('rules_of_road', 1, 'Where may you legally stop with your vehicle?', '[{"text": "4m from a tunnel"}, {"text": "5m from a pedestrian crossing"}, {"text": "6m from a railway crossing"}]'::jsonb, 2, 'You may stop 6m from a railway crossing. Other distances may have specific restrictions.', 2, NULL),
    ...
    -- Q44
    ('rules_of_road', 1, 'The only instance where you may stop on a freeway...', '[{"text": "To obey the road traffic sign"}, {"text": "For a rest during a tiring journey"}, {"text": "To pick up hitchhikers"}]'::jsonb, 0, 'You may only stop on a freeway to obey traffic signs or in genuine emergencies, not for rest or picking up people.', 2, NULL),
    
    -- Q45
    ('rules_of_road', 1, 'When may a driver disobey a rule of the road...?', '[{"text": "Only when directed to do so by a traffic officer"}, {"text": "Under no circumstances"}, {"text": "If you are driving in a emergency situation"}]'::jsonb, 0, 'You may only disobey traffic rules when specifically directed to do so by a traffic officer.', 2, NULL),
    
    -- Q46
    ('rules_of_road', 1, 'What is the duty of a driver when driving on a public road that has been divided into two or more roadways?', '[{"text": "You may drive on any part of the roadway"}, {"text": "You are allowed to drive on any part of the roadway after sunset, or when there is no other traffic on the road"}, {"text": "Drive on the left hand roadway unless directed or shown to do so by a traffic officer or traffic sign"}]'::jsonb, 2, 'On divided roadways, drive on the left-hand roadway unless signs or officers direct otherwise.', 2, NULL),
    
    -- Q47
    ('rules_of_road', 1, 'When a motor vehicle is standing still, what must the driver do to make sure the motor vehicle does not move...?', '[{"text": "The gear lever must be put in the neutral position"}, {"text": "The parking brake must be applied"}, {"text": "The driver must hold the service brake"}]'::jsonb, 1, 'Always apply the parking brake when the vehicle is stationary to prevent unintended movement.', 1, NULL),
    
    -- Q48
    ('rules_of_road', 1, 'What colour and size must flags be to indicate projections on a vehicle on a public road,....', '[{"text": "They can be any size as long as they are red"}, {"text": "They must be red and at least 300 x 300mm"}, {"text": "They may be any colour as long as they are visible"}]'::jsonb, 1, 'Projection flags must be red and at least 300x300mm to be clearly visible to other road users.', 2, NULL),
    
    -- Q49
    ('rules_of_road', 1, 'A Temporary sign...?', '[{"text": "Need not be taken seriously at all times"}, {"text": "Is of less importance to road users than a permanent sign"}, {"text": "Has the same legal significance as a permanent sign"}]'::jsonb, 2, 'Temporary signs have the same legal force as permanent signs and must be obeyed.', 1, NULL),
    
    -- Q50
    ('rules_of_road', 1, 'What is the duty of a driver, about pedestrians at a pedestrian crossing...?', '[{"text": "A driver must only stop for a pedestrian waiting to enter the road at a pedestrian signal"}, {"text": "A driver must yield right of way to a pedestrian crossing a pedestrian crossing"}, {"text": "A driver must yield to all pedestrians wishing to cross over the road way"}]'::jsonb, 1, 'Drivers must yield to pedestrians actually crossing at designated pedestrian crossings.', 1, NULL),
    
    -- Q51
    ('rules_of_road', 1, 'When is it permissible to allow a portion of the body to project beyond the vehicle...?', '[{"text": "Only for the driver to give hand signals"}, {"text": "Only passengers may allow a portion of their bodies to project, they don''t need 2 hands on the steering wheel"}, {"text": "When it is hot and the driver''s window is open"}]'::jsonb, 0, 'Only the driver may extend body parts to give legal hand signals. Passengers should remain fully inside.', 1, NULL),
    ...
    -- Q53
    ('rules_of_road', 1, 'How far behind a vehicle must the warning triangle be placed if your car breaks down?', '[{"text": "At least 45 m"}, {"text": "At least 10m"}, {"text": "At least 100m"}]'::jsonb, 0, 'Place warning triangles at least 45m behind your broken down vehicle to alert approaching traffic.', 1, NULL),
    ...
    -- Q63
    ('rules_of_road', 1, 'What is the minimum distance stop lamps must be visible to a person with normal eyesight in sunlight...?', '[{"text": "20m"}, {"text": "30m"}, {"text": "10m"}]'::jsonb, 1, 'Stop lamps (brake lights) must be visible from at least 30m in sunlight to effectively warn following traffic.', 1, NULL),
    
    -- Q64
    ('rules_of_road', 1, 'When driving a vehicle alone, what documents must you carry with you...?', '[{"text": "Any persons valid drivers licence if you only have a learners licence"}, {"text": "Your original valid drivers licence"}, {"text": "A certified copy of your drivers licence and id document"}]'::jsonb, 1, 'You must carry your original, valid driver''s license when operating a motor vehicle.', 1, NULL),
    
    -- Q65
    ('rules_of_road', 1, 'When are you allowed to drive on the right hand side of a freeway...?', '[{"text": "When you are driving 120kph"}, {"text": "At anytime as long as I don''t stop in the right hand lane"}, {"text": "Only when overtaking another vehicle"}]'::jsonb, 2, 'The right lane on freeways is primarily for overtaking. Return to left lanes after passing.', 1, NULL),
    
    -- Q66
    ('rules_of_road', 1, 'How long must a flicker be displayed?', '[{"text": "for long enough to show vehicles or persons approaching you of your intentions"}, {"text": "For about 3 mins"}, {"text": "For about 2 mins"}]'::jsonb, 0, 'Indicators must be used long enough to clearly communicate your intentions to other road users.', 1, NULL),
    
    -- Q67
    ('rules_of_road', 1, 'When may you pass another vehicle that has stopped at a pedestrian crossing?', '[{"text": "You can pass if its safe to do so"}, {"text": "It is prohibited to pass any vehicle that has stopped at a pedestrian crossing"}, {"text": "You may pass only once the pedestrian has crossed"}]'::jsonb, 1, 'Never pass a vehicle stopped at a pedestrian crossing, as pedestrians may be crossing out of view.', 2, NULL),
    
    -- Q68
    ('rules_of_road', 1, 'A light motor vehicle fitted with a spot lamp may be used on a public road...', '[{"text": "If it''s a breakdown vehicle at a collision scene"}, {"text": "With a light that''s beam can shine in any direction"}, {"text": "If the lights are not connected"}]'::jsonb, 0, 'Spot lamps may only be used by authorized emergency or breakdown vehicles at incident scenes.', 2, NULL),
    
    -- Q69
    ('rules_of_road', 1, 'Which statement is False? A vehicle may be used on a public road if......', '[{"text": "The battery and electrical wiring are properly installed"}, {"text": "The fuel cap is effective and closed"}, {"text": "The fuel tank is defective"}]'::jsonb, 2, 'A vehicle with a defective fuel tank may NOT be used on public roads due to safety hazards.', 2, NULL),
    
    -- Q70
    ('rules_of_road', 1, 'You are in heavy traffic in the right hand lane,..the car in front wants to turn into his driveway and has stopped, waiting for heavy oncoming traffic, what do you do?', '[{"text": "Wait behind the car until you get the opportunity to pass, and when its safe ...proceed"}, {"text": "Switch on your left flicker and move to the left lane"}, {"text": "Hoot, wave and pass"}]'::jsonb, 0, 'Wait patiently behind the turning vehicle. Never attempt dangerous maneuvers like swerving into other lanes.', 2, NULL),
    
    -- Q71
    ('rules_of_road', 1, 'The use of a temporary sign implies that for some reason...?', '[{"text": "The rules of the road do not apply"}, {"text": "The situation on the road is not normal"}, {"text": "Traffic must move slowly"}]'::jsonb, 1, 'Temporary signs indicate abnormal road conditions that require special attention and caution.', 1, NULL),
    
    -- Q72
    ('rules_of_road', 1, 'How far must you be parked from either side of a fire hydrant', '[{"text": "1.5 meter"}, {"text": "750mm"}, {"text": "1 meter"}]'::jsonb, 0, 'Maintain at least 1.5m clearance from fire hydrants to ensure emergency access if needed.', 1, NULL),
    
    -- VEHICLE CONTROLS QUESTIONS
    -- Code 1 (Motorcycle) Controls
    
    -- Q192
    ('vehicle_controls', 1, 'To ride faster, you must use number...', '[{"text": "7"}, {"text": "5"}, {"text": "4"}]'::jsonb, 2, 'Number 4 is the throttle control. To increase speed, gradually roll the throttle forward.', 1, NULL),
    
    -- Q193
    ('vehicle_controls', 1, 'To turn you must use number', '[{"text": "8"}, {"text": "1"}, {"text": "7"}]'::jsonb, 0, 'Number 8 is the steering. To turn, lean the motorcycle and gently counter-steer in the desired direction.', 1, NULL),
    
    -- Q194
    ('vehicle_controls', 1, 'To stop you must use number...', '[{"text": "4 and 7"}, {"text": "2 and 7"}, {"text": "1 and 2"}]'::jsonb, 1, 'Number 2 (front brake lever) and 7 (rear brake pedal) are used together for controlled stopping.', 1, NULL),
    
    -- Q195
    ('vehicle_controls', 1, 'To change gears, you must use numbers...', '[{"text": "1 and 5"}, {"text": "2 and 7"}, {"text": "1 and 2"}]'::jsonb, 0, 'Number 1 (clutch lever) and 5 (gear lever) are used together for smooth gear changes.', 1, NULL),
    
    -- Q196
    ('vehicle_controls', 1, 'To indicate that you are going to turn you must use number...', '[{"text": "6"}, {"text": "4"}, {"text": "8"}]'::jsonb, 0, 'Number 6 is the indicator switch. Use it to signal your intention to turn well in advance.', 1, NULL),
    
    -- Q197
    ('vehicle_controls', 1, 'What controls must you use when you are going to make a sharp turn?', '[{"text": "1,3,5,6 and 8 only"}, {"text": "1,2,4 and 8 only"}, {"text": "1,2,3,4,6 and 8 only"}]'::jsonb, 2, 'Sharp turns require clutch control, both brakes, throttle modulation, indicators, and steering coordination.', 2, NULL),
    
    -- Q198
    ('vehicle_controls', 1, 'What controls must you never use in combination?', '[{"text": "2 and 4"}, {"text": "4 and 8"}, {"text": "4 and 7"}]'::jsonb, 0, 'Never use front brake (2) and throttle (4) aggressively together as this can cause loss of control.', 2, NULL),
    
    -- Code 2 (Light Motor Vehicle) Controls
    
    -- Q212
    ('vehicle_controls', 2, 'To select a gear you must use numbers...', '[{"text": "789"}, {"text": "588"}, {"text": "688"}]'::jsonb, 2, 'In manual vehicles, use clutch (8) and gear lever (4) to select gears. "688" likely refers to clutch and gear operation.', 1, NULL),
    
    -- Q213
    ('vehicle_controls', 2, 'To stop your vehicle, you must use number...', '[{"text": "9"}, {"text": "8"}, {"text": "7"}]'::jsonb, 2, 'Number 7 is the foot brake (service brake) used for normal stopping in light motor vehicles.', 1, NULL),
    
    -- Q214
    ('vehicle_controls', 2, 'Number...is not found in an automatic vehicle', '[{"text": "2"}, {"text": "6"}, {"text": "8"}]'::jsonb, 2, 'Number 8 is the clutch pedal, which is not present in automatic transmission vehicles.', 1, NULL),
    
    -- Q215
    ('vehicle_controls', 2, 'To turn, number...is used', '[{"text": "4"}, {"text": "5"}, {"text": "10"}]'::jsonb, 0, 'Number 4 is the steering wheel, used to control the direction of the vehicle.', 1, NULL),
    
    -- Q216
    ('vehicle_controls', 2, 'To ensure that your parked vehicle does not move you must use number...', '[{"text": "7"}, {"text": "8"}, {"text": "9"}]'::jsonb, 2, 'Number 9 is the handbrake (parking brake), used to secure the vehicle when parked.', 1, NULL),
    
    -- Q217
    ('vehicle_controls', 2, 'To accelerate your vehicle you must use number', '[{"text": "6"}, {"text": "8"}, {"text": "10"}]'::jsonb, 0, 'Number 6 is the accelerator pedal, used to increase engine speed and vehicle velocity.', 1, NULL),
    
    -- Q218
    ('vehicle_controls', 2, 'What controls must you use when you are going to turn sharp', '[{"text": "1,3,5,6 and 8 only"}, {"text": "3,4,5,9 and 10 only"}, {"text": "1,3,4,5,6,8,9 and 10 only"}]'::jsonb, 2, 'Sharp turns require comprehensive control: steering, indicators, gear selection, acceleration, clutch, handbrake, and mirror checks.', 2, NULL),
    
    -- Code 3 (Heavy Motor Vehicle) Controls
    
    -- Q230
    ('vehicle_controls', 3, 'To select a gear, you must use numbers...', '[{"text": "789"}, {"text": "588"}, {"text": "688"}]'::jsonb, 2, 'Heavy vehicles use clutch (8) and gear lever (4) for gear selection. "688" refers to clutch operation.', 1, NULL),
    
    -- Q231
    ('vehicle_controls', 3, 'To stop your vehicle you must use number...', '[{"text": "9"}, {"text": "8"}, {"text": "7"}]'::jsonb, 2, 'Number 7 is the foot brake, essential for controlled stopping in heavy vehicles.', 1, NULL),
    
    -- Q232
    ('vehicle_controls', 3, 'To turn your vehicle, number... is used', '[{"text": "5"}, {"text": "4"}, {"text": "6"}]'::jsonb, 1, 'Number 4 is the steering wheel, used to direct heavy vehicles through turns.', 1, NULL),
    
    -- Q233
    ('vehicle_controls', 3, 'To ensure that your parked vehicle does not move, use number...', '[{"text": "7"}, {"text": "8"}, {"text": "9"}]'::jsonb, 2, 'Number 9 is the parking brake, crucial for securing heavy vehicles when stationary.', 1, NULL),
    
    -- Q234
    ('vehicle_controls', 3, 'To accelerate your vehicle you must use number...', '[{"text": "6"}, {"text": "8"}, {"text": "10"}]'::jsonb, 0, 'Number 6 is the accelerator, used to increase speed in heavy vehicles.', 1, NULL),
    
    -- Q235
    ('vehicle_controls', 3, 'What controls must you use when you are going to turn sharp?', '[{"text": "1, 3, 5, 6 and 8 only"}, {"text": "3, 4, 5, 9 and 10 only"}, {"text": "1, 3, 4, 5, 6, 8 and 9 only"}]'::jsonb, 2, 'Sharp turns in heavy vehicles require steering, indicators, gear control, acceleration, clutch, and parking brake management.', 2, NULL),
    
    -- Q236
    ('vehicle_controls', 3, 'To indicate that you are going to turn, you must use number...', '[{"text": "3"}, {"text": "5"}, {"text": "11"}]'::jsonb, 0, 'Number 3 is the indicator lever, used to signal turning intentions in heavy vehicles.', 1, NULL)
...
SELECT 'Successfully inserted ' || COUNT(*) || ' Evolve Driving Academy questions with images' AS result FROM questions WHERE created_at > NOW() - INTERVAL '1 minute';
